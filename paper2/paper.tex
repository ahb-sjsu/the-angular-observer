...
Seed replication is done (\S\ref{sec:seeds}: two rules fully stable, one
deterministic, one tipping between adjacent templates, one genuinely
seed-dependent), but the growth sweep remains single-seed per stage;
hop-count geodesics; $n\le2000$ dense-eigensolver scale; four
