...
which is delicate. (Citation details of \cite{nss}, including the precise statement number,
are to be checked against the source in the reference-verification pass.)
\end{remark}
