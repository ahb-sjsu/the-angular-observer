...
def measure(A):
    ...
    return (
        ...
        dim_ball_growth(A),
        dim_spectral(w),
        dim_effective_rank(A, w, V),
        angle_rho(A, w, V, rng=RNG),
    )
...
if __name__ == "__main__":
    ...
    print(
        "earlier: collapse gen=500 -> N=501 ball2.06 spec2.03 eff2.13 "
    ...
    for sname, seed, mg in CONFIGS:
        ...
        print(
            f"  {sname:9s} gen={mg:5d}: N={n:5d} tris={len(tris):5d} | "
